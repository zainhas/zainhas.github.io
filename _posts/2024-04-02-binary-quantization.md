...
thumbnail: /assets/img/posts/2024-04-02-binary-quantization/hero.png
---

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-04-02-binary-quantization/hero.png" title="'32x Reduced Memory Usage With Binary Quantization'" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/bq_vecs.png').default}
  alt="bq vectors"
...
|:-------------------------:|:-------------------------: |
| ![OriginalImage](/assets/img/posts/2024-04-02-binary-quantization/image11.png)  |  ![BinaryImage](/assets/img/posts/2024-04-02-binary-quantization/image9.png) |
...
|:-------------------------:|
| ![OriginalVec](/assets/img/posts/2024-04-02-binary-quantization/image14.jpg)  |
|  ![BinaryVec](/assets/img/posts/2024-04-02-binary-quantization/image7.png)    |
...
<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/image24.png').default}
  alt="BQ Distance"
...
<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/image19.png').default}
  alt="1D BQ"
  style={{ maxWidth: "80%", margin: "0 auto", display: "block" }}
/>
...
|:-------------------------:|:-------------------------: |
| ![OriginalVectors](/assets/img/posts/2024-04-02-binary-quantization/image18.png)  |  ![BinaryVectors](/assets/img/posts/2024-04-02-binary-quantization/image8.png) |
...
|Original Vectors            |  BQ Vectors |
|:-------------------------:|:-------------------------: |
| ![OriginalVectorsUN](/assets/img/posts/2024-04-02-binary-quantization/image17.png)  |  ![BinaryVectorsUN](/assets/img/posts/2024-04-02-binary-quantization/image16.png) |
...
<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/image3.png').default}
...
<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/image4.png').default}
...
<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/image21.png').default}
  alt="latency"
  style={{ maxWidth: "80%", margin: "0 auto", display: "block" }}
/>
...
<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/image15.png').default}
  alt="latency 100k"
  style={{ maxWidth: "80%", margin: "0 auto", display: "block" }}
/>

<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/image6.png').default}
  alt="latency 100k 2"
  style={{ maxWidth: "80%", margin: "0 auto", display: "block" }}
/>
...
<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/image13.png').default}
  alt="latency 1000k"
  style={{ maxWidth: "80%", margin: "0 auto", display: "block" }}
/>
<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/image20.png').default}
  alt="latency 1000k 2"
  style={{ maxWidth: "80%", margin: "0 auto", display: "block" }}
/>
...
<img
  src={require('/assets/img/posts/2024-04-02-binary-quantization/image22.png').default}
  alt="latency PQ v BQ"
  style={{ maxWidth: "80%", margin: "0 auto", display: "block" }}
/>
