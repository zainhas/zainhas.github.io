...
thumbnail: /assets/img/posts/2024-03-26-intel/hero.png
---


<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-03-26-intel/hero.png" title="'Accelerating Vector Search up to +40% with Intel’s latest Xeon CPU - Emerald Rapids'" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
![Vector Distance Calculations](/assets/img/posts/2024-03-26-intel/vector_distance.png)
...
![SIMD](/assets/img/posts/2024-03-26-intel/SIMD.png)
...
<img
  src={require('/assets/img/posts/2024-03-26-intel/intel_slide.png').default}
...
<figure>
  <img
    src={require('/assets/img/posts/2024-03-26-intel/micro_bench.png').default}
...
<figure>
  <img
    src={require('/assets/img/posts/2024-03-26-intel/dbpedia_bench.png').default}
...
<figure>
  <img
  src={require('/assets/img/posts/2024-03-26-intel/sphere_bench.png').default}
