...
tags: rag machine-learning ai vector-databases
categories: technical-blog
thumbnail: /assets/img/posts/2024-07-25-advanced-rag/hero.png
---

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/hero.png" title="Advanced RAG" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

In this post we'll dig into Retrieval-Augmented Generation (RAG) and show you practical tips and tricks to improve every part of the RAG pipeline! We'll start by considering a practical example: building a chatbot to emulate or assist a human doctor.
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image1.png" title="RAG Framework" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image2.png" title="RAG Labelled" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image3.png" title="Text Splitting" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

*Credit: [Greg Kamradt (Data Indy)](https://github.com/FullStackRetrieval-com/RetrievalTutorials/blob/main/tutorials/LevelsOfTextSplitting/5_Levels_Of_Text_Splitting.ipynb) - Text Splitting*
...
- **Pros and Cons**: Produces more coherent and contextually meaningful chunks, improving retrieval accuracy but requires forward passes through a BERT based encoder model which is more computationally intensive than simple chunking.

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image4.png" title="Semantic Chunking" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

*Credit: [Greg Kamradt (Data Indy)](https://github.com/FullStackRetrieval-com/RetrievalTutorials/blob/main/tutorials/LevelsOfTextSplitting/5_Levels_Of_Text_Splitting.ipynb) - Semantic Chunking*
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image5.png" title="LLM Chunking" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

*Credit: [Dense X Retrieval: What Retrieval Granularity Should We Use?](https://arxiv.org/abs/2312.06648)*

Model: [https://huggingface.co/chentong00/propositionizer-wiki-flan-t5-large](https://huggingface.co/chentong00/propositionizer-wiki-flan-t5-large)
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image6.png" title="Metadata Filtering" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

*Credit: [MyScale](https://medium.com/@myscale/optimizing-filtered-vector-search-in-myscale-77675aaa849c)*

#### 2. Using GLiNER to Generate Metadata for Chunks

You might not always have extensive metadata to augment your chunks with but using the GLiNER (Generalized Linear Named Entity Recognizer) model you can generate metadata from chunks on the go! GLiNER is a robust BERT based model that can be used to tag and label chunks during the ingestion phase to create metadata on the go. This can significantly improve the retrieval process.

- **Autolabeling with GLiNER**:
  - **Implementation**: You can simply provide each chunk into GLiNER along with the tags you want to identify in the chunk. If the tags are found in the chunk text it will identify them if nothing matches with high confidence then tags won't be produced, reducing false positives!
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image7.png" title="GLiNER" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

*Credit: [GLiNER: Generalist Model for Named Entity Recognition using Bidirectional Transformer](https://arxiv.org/abs/2311.08526)*

Demo: [https://huggingface.co/spaces/urchade/gliner_multiv2.1](https://huggingface.co/spaces/urchade/gliner_multiv2.1)
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image8.png" title="Hybrid Search" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image9.png" title="Query Rewriting" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

*Credit: [Query Rewriting - Ma et al. 2023](https://arxiv.org/abs/2305.14283)*
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image10.png" title="Autocut" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

*Credit: [AutoCut](https://docs.weaviate.io/weaviate/api/graphql/additional-operators#autocut)*
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/posts/2024-07-25-advanced-rag/image11.png" title="Reranking" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

*Credit: [Reranking](https://docs.weaviate.io/weaviate/search/rerank)*
